 ...
 */
object SubscriptionModel : riven.core.models.core.CoreModelDefinition(
    key = "subscription",
    ...
    attributes = mapOf(
        ...
        "status" to CoreModelAttribute(
            ...
            options = SchemaOptions(
                enum = listOf("trialing", "active", "past-due", "cancelled", "paused"),
                defaultValue = DefaultValue.Static("trialing")
            ),
            semantics = AttributeSemantics(
