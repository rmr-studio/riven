 ...
 */
object SupportTicketModel : riven.core.models.core.CoreModelDefinition(
    key = "support-ticket",
    ...
    attributes = mapOf(
        ...
        "priority" to CoreModelAttribute(
            ...
            options = SchemaOptions(
                ...
                defaultValue = DefaultValue.Static("medium")
            ),
            semantics = AttributeSemantics(
        ...
        "status" to CoreModelAttribute(
            ...
            required = true,
            options = SchemaOptions(
                enum = listOf("open", "in-progress", "resolved", "closed"),
                defaultValue = DefaultValue.Static("open")
            ),
            semantics = AttributeSemantics(
