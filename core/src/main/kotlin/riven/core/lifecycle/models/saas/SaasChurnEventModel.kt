 ...
 */
object SaasChurnEventModel : CoreModelDefinition(
    key = "churn-event",
    ...
    attributes = ChurnEventBase.attributes + mapOf(
        "reason" to CoreModelAttribute(
            ...
            required = true,
            options = SchemaOptions(enum = listOf("price", "competitor", "no-longer-needed", "poor-experience", "missing-feature", "onboarding-failure", "product-issue", "unknown")),
