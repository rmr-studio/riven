...
CREATE INDEX idx_workflow_definition_versions_workspace_id ON workflow_definition_versions (workspace_id) where deleted = FALSE AND deleted_at IS NULL;
CREATE INDEX idx_workflow_definition_versions_definition ON workflow_definition_versions (workspace_id, workflow_definition_id) where deleted = FALSE AND deleted_at IS NULL;
