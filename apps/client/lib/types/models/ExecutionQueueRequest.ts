...
export function ExecutionQueueRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExecutionQueueRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ExecutionQueueRequestToJSONTyped(value?: ExecutionQueueRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
