...
export function EntityReferenceMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityReferenceMetadata {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityReferenceMetadataToJSONTyped(value?: EntityReferenceMetadata | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
