...
| **type** | `ApplicationEntityType` |  | [Defaults to `undefined`] [Enum: WORKSPACE, BLOCK_TYPE, BLOCK, USER, ENTITY, ENTITY_TYPE, WORKFLOW_DEFINITION, WORKFLOW_NODE, WORKFLOW_EDGE, INTEGRATION_CONNECTION, FILE, NOTIFICATION, INTEGRATION_INSTALLATION, MATCH_SUGGESTION, IDENTITY_CLUSTER, NOTE] |
