...
| **type** | `ApplicationEntityType` |  | [Defaults to `undefined`] [Enum: WORKSPACE, BLOCK_TYPE, BLOCK, USER, ENTITY, ENTITY_TYPE, WORKFLOW_DEFINITION, WORKFLOW_NODE, WORKFLOW_EDGE, INTEGRATION_CONNECTION, FILE, NOTIFICATION, INTEGRATION_INSTALLATION, MATCH_SUGGESTION, IDENTITY_CLUSTER, NOTE, BUSINESS_DEFINITION, DATA_CONNECTOR_CONNECTION, INSIGHTS_CHAT_SESSION, INSIGHTS_MESSAGE] |
