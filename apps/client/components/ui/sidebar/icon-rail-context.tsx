...
export type PanelId = 'workspaces' | 'overview' | 'entities' | 'knowledge' | 'notes' | 'billing' | 'settings';
...
export function IconRailProvider({ children }: { children: ReactNode }) {
  ...
  const validPanels: PanelId[] = ['workspaces', 'overview', 'entities', 'knowledge', 'notes', 'billing', 'settings'];
