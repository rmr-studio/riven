...
| 2026-03-12 | Added `onboarding_completed_at` (nullable timestamp) field to User entity and model — tracks whether a user has completed the onboarding flow | [[Onboarding]] |
