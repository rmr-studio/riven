...
- [[Lifecycle Domain Model]] — domains being measured
- [[Lifecycle-Aware Onboarding Flow]] — coverage summary during onboarding
- [[Lifecycle Operations Dashboard]] — persistent indicator on dashboard
