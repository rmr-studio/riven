...
- [[riven/docs/system-design/feature-design/4. Completed/Semantic Entity Groups]] — orthogonal classification (SemanticGroup = WHAT, LifecycleDomain = WHERE)
...
- [[riven/docs/system-design/feature-design/5. Backlog/Knowledge Layer Sub-Agents]] — perspectives scoped to lifecycle domains
