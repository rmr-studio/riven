...
export const knowledgeScrollContent: KnowledgeLayerSectionContent[] = [
  ...
  },
  {
    ...
    content: <SubAgentsDiagram className="translate-x-8 scale-100" />,
  },
  {
    ...
    content: <PatternsDiagram className="translate-x-8" />,
  },

  {
    ...
    content: <ContextDiagram className="translate-x-16 -translate-y-24 scale-65" />,
  },
];
