...
const edgePaths = [
  ...
  { d: 'M142 233V164C142 161.791 143.791 160 146 160H334', delay: 0.4 },
  {
    d: 'M605.051 159L812.051 159C814.26 159 816.051 157.209 816.051 155L816.051 110',
    delay: 0.5,
  },
];
...
export const InterconnectionDiagram = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 955 357" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      {/* ===== User Entity ===== */}
      <g>
        <g filter="url(#filter1_d_47_128)">
          <rect x="329" y="84" width="277" height="157" rx="16" className="fill-card" />
          <rect x="329.5" y="84.5" width="276" height="156" rx="15.5" className="stroke-border" />
        </g>
        <path
        ...
        />
        <rect x="344" y="135" width="247" height="2" className="fill-border" />
        <text
        ...
        <path
          d="M364.667 169.667L358.673 173.485C358.469 173.603 358.238 173.665 358.003 173.665C357.768 173.665 357.537 173.603 357.333 173.485L351.333 169.667M352.667 167.667H363.333C364.07 167.667 364.667 168.264 364.667 169V177C364.667 177.736 364.07 178.333 363.333 178.333H352.667C351.93 178.333 351.333 177.736 351.333 177V169C351.333 168.264 351.93 167.667 352.667 167.667Z"
        ...
        <path
          d="M359 148.333H357M360 144.333L359.333 145.667H361.333C361.687 145.667 362.026 145.807 362.276 146.057C362.526 146.307 362.667 146.646 362.667 147V156.333C362.667 156.687 362.526 157.026 362.276 157.276C362.026 157.526 361.687 157.667 361.333 157.667H354.667C354.313 157.667 353.974 157.526 353.724 157.276C353.474 157.026 353.333 156.687 353.333 156.333V147C353.333 146.646 353.474 146.307 353.724 146.057C353.974 145.807 354.313 145.667 354.667 145.667H356.667M361.266 157.667C361.113 156.913 360.704 156.236 360.109 155.75C359.513 155.264 358.768 154.998 358 154.998C357.231 154.998 356.486 155.264 355.891 155.75C355.296 156.236 354.887 156.913 354.733 157.667M356 144.333L358 148.333M360 153C360 154.104 359.105 155 358 155C356.895 155 356 154.104 356 153C356 151.895 356.895 151 358 151C359.105 151 360 151.895 360 153Z"
          className="stroke-muted-foreground"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      <motion.g initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.4 }}>
        <g filter="url(#filter7_d_47_128)">
          ...
          />
          <path
            d="M19 234H264C272.56 234 279.5 240.94 279.5 249.5V327.5C279.5 336.06 272.56 343 264 343H19C10.4396 343 3.5 336.06 3.5 327.5V249.5C3.5 240.94 10.4396 234 19 234Z"
            className="stroke-border"
          />
        </g>
        <path
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <rect x="19" y="288" width="247" height="2" className="fill-border" />
        <text
          className="fill-foreground"
          style={{ whiteSpace: 'pre' }}
          xmlSpace="preserve"
      ...
      <defs>
        ...
        <clipPath id="clip0_47_128">
          <rect width="16" height="16" fill="white" transform="translate(350 189)" />
        </clipPath>
        <clipPath id="clip1_47_128">
          <rect width="16" height="16" fill="white" transform="translate(350 189)" />
        </clipPath>
        <clipPath id="clip2_47_128">
          <rect width="16" height="16" fill="white" transform="translate(350 213)" />
        </clipPath>
        <clipPath id="clip3_47_128">
          <rect width="19" height="19" fill="white" transform="translate(696 23)" />
        </clipPath>
        <clipPath id="clip4_47_128">
          <rect width="19" height="19" fill="white" transform="translate(669 270)" />
        </clipPath>
      </defs>
    </svg>
  );
