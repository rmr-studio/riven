...
- Current mitigation: Only NEXT_PUBLIC_* variables exposed (Next.js convention), Supabase uses anon key (safe for client-side)
- Recommendations: Audit all NEXT_PUBLIC_ variables to ensure no sensitive data leaked
