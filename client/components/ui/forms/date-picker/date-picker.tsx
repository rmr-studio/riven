    ...
    <Popover open={open} onOpenChange={setOpen} modal={modal}>
      <PopoverTrigger asChild>
        {renderTrigger ? (
          ...
          <div
            className={cn(
              'flex h-9 w-full cursor-pointer items-center rounded-md border border-input ps-3 pe-1 text-sm font-normal shadow-sm',
      ...
      <PopoverContent className="w-auto p-2">
        ...
        <div className="relative overflow-hidden border-t pt-2">
          ...
          <MonthYearPicker
            ...
            maxDate={maxDate}
            className={cn(
              'absolute top-0 right-0 bottom-0 left-0 pt-2',
        ...
        <div className="flex flex-col gap-2">
          ...
          {!exitOnClick && (
            <div className="mt-2 flex flex-row-reverse items-center justify-between border-t py-1">
              <Button className="ms-2 mt-2 h-7 px-2" onClick={onSubmit}>
                Done
              </Button>
              {timezone && (
