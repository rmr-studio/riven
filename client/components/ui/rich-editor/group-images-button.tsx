...
export function GroupImagesButton({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="flex items-center gap-2 rounded-lg border border-border bg-background p-2 shadow-2xl">
          {/* Selection count */}
          ...
          {inSameFlex ? (
            <>
              {/* Reverse button */}
              {onReverse && (
                <Button onClick={onReverse} size="sm" variant="secondary" className="gap-2">
              ...
              {/* Extract button */}
              {onExtract && (
                <Button onClick={onExtract} size="sm" variant="secondary" className="gap-2">
