...
export function CustomClassPopover() {
  ...
  const TriggerButton = () => (
    <button
      ...
      className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-border bg-background shadow-lg transition-all hover:scale-110 hover:border-primary"
      onMouseDown={(e) => {
