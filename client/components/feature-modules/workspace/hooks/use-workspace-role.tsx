import { WorkspaceRole } from "@/components/feature-modules/workspace/interface/workspace.interface";
...
export const useWorkspaceRole = (): UseWorkspaceRoleReturn => {
    ...
    const role: WorkspaceRole | null =
        workspace?.members?.find((member) => member.user.id === session?.user.id)?.membershipDetails
            .role ?? null;
