...
import { inviteToWorkspace } from "@/components/feature-modules/organisation/service/workspace.service";
...
const InviteMemberForm: FC<Props> = ({ workspace }) => {
    const { session } = useAuth();
    const { hasRole } = useWorkspaceRole();
