import {
    ...
    WorkspaceMember,
    WorkspaceRole,
} from "@/components/feature-modules/organisation/interface/workspace.interface";
...
export const MemberCell = memo(({ member }: { member: WorkspaceMember }) => (
...
interface MemberActionProps {
    ...
    onUpdate: (id: string, role: WorkspaceRole) => void;
}
