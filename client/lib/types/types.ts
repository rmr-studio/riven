...
export interface components {
  schemas: {
    ...
    UpdateWorkflowNodeRequest: {
      ...
      description?: string;
      config?:
        | components['schemas']['WorkflowActionConfig']
        | components['schemas']['WorkflowControlConfig']
        | components['schemas']['WorkflowFunctionConfig']
        | components['schemas']['WorkflowHumanInteractionConfig']
        | components['schemas']['WorkflowTriggerConfig']
        | components['schemas']['WorkflowUtilityConfig'];
    };
    WorkflowActionConfig: WithRequired<
      components['schemas']['WorkflowNodeConfig'],
      'type' | 'version'
    > & {
    ...
    WorkflowControlConfig: WithRequired<
      components['schemas']['WorkflowNodeConfig'],
      'type' | 'version'
    > & {
    ...
    WorkflowFunctionConfig: WithRequired<
      components['schemas']['WorkflowNodeConfig'],
      'type' | 'version'
    >;
    WorkflowHumanInteractionConfig: WithRequired<
      components['schemas']['WorkflowNodeConfig'],
      'type' | 'version'
    > & {
    ...
    WorkflowTriggerConfig: WithRequired<
      components['schemas']['WorkflowNodeConfig'],
      'type' | 'version'
    > & {
    ...
    WorkflowUtilityConfig: WithRequired<
      components['schemas']['WorkflowNodeConfig'],
      'type' | 'version'
    > & {
    ...
    EntityAttributePrimitivePayload: WithRequired<
      components['schemas']['EntityAttributePayload'],
      'type'
    > & {
      value?: Record<string, never>;
    ...
    EntityAttributeRelationPayload: WithRequired<
      components['schemas']['EntityAttributePayload'],
      'type'
    > & {
    ...
    EntityAttributeRelationPayloadReference: WithRequired<
      components['schemas']['EntityAttributePayload'],
      'type'
    > & {
      relations: string[];
    ...
    DeleteAttributeDefinitionRequest: WithRequired<
      components['schemas']['TypeDefinition'],
      'id' | 'key' | 'type'
    >;
    /** @description Request to remove a relationship definition for an entity type */
    DeleteRelationshipDefinitionRequest: WithRequired<
      components['schemas']['TypeDefinition'],
      'id' | 'key' | 'type'
    > & {
    ...
    SaveAttributeDefinitionRequest: WithRequired<
      components['schemas']['TypeDefinition'],
      'id' | 'key' | 'type'
    > & {
      schema: components['schemas']['SchemaUUID'];
    ...
    SaveRelationshipDefinitionRequest: WithRequired<
      components['schemas']['TypeDefinition'],
      'id' | 'key' | 'type'
    > & {
    ...
    Block: {
      ...
      payload:
        | components['schemas']['EntityReferenceMetadata']
        | components['schemas']['BlockReferenceMetadata']
        | components['schemas']['BlockContentMetadata'];
      validationErrors?: string[];
      /** Format: date-time */
      createdAt?: string;
      /** Format: date-time */
    ...
    BlockContentMetadata: WithRequired<
      components['schemas']['Metadata'],
      'deletable' | 'meta' | 'readonly' | 'type'
    > & {
      data: {
        [key: string]: unknown;
      };
    ...
    ReferenceMetadata: WithRequired<
      components['schemas']['Metadata'],
      'deletable' | 'meta' | 'readonly' | 'type'
    > & {
    ...
    ReferenceNode: WithRequired<components['schemas']['Node'], 'block' | 'type' | 'warnings'> & {
      reference:
        | components['schemas']['EntityReference']
        | components['schemas']['BlockTreeReference'];
    } & {
    ...
    MoveBlockOperation: WithRequired<
      components['schemas']['BlockOperation'],
      'blockId' | 'type'
    > & {
      /** Format: uuid */
      fromParentId?: string;
    ...
    RemoveBlockOperation: WithRequired<
      components['schemas']['BlockOperation'],
      'blockId' | 'type'
    > & {
      childrenIds: {
    ...
    ReorderBlockOperation: WithRequired<
      components['schemas']['BlockOperation'],
      'blockId' | 'type'
    > & {
      /** Format: uuid */
    ...
    UpdateBlockOperation: WithRequired<
      components['schemas']['BlockOperation'],
      'blockId' | 'type'
    > & {
