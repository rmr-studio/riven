...
export function EntityAttributeRelationPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityAttributeRelationPayload {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityAttributeRelationPayloadToJSONTyped(value?: EntityAttributeRelationPayload | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
