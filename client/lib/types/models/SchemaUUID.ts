...
export function SchemaUUIDFromJSONTyped(json: any, ignoreDiscriminator: boolean): SchemaUUID {
    ...
    return {
        ...
        'properties': json['properties'] == null ? undefined : (mapValues(json['properties'], SchemaUUIDFromJSON)),
...
export function SchemaUUIDToJSONTyped(value?: SchemaUUID | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'properties': value['properties'] == null ? undefined : (mapValues(value['properties'], SchemaUUIDToJSON)),
