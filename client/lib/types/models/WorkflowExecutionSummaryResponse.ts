 ...
 */
export function instanceOfWorkflowExecutionSummaryResponse(
  value: object,
): value is WorkflowExecutionSummaryResponse {
...
export function WorkflowExecutionSummaryResponseFromJSON(
  json: any,
): WorkflowExecutionSummaryResponse {
  return WorkflowExecutionSummaryResponseFromJSONTyped(json, false);
}

export function WorkflowExecutionSummaryResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    failedNode:
      json['failedNode'] == null
        ? undefined
        : WorkflowExecutionNodeRecordFromJSON(json['failedNode']),
  };
}

export function WorkflowExecutionSummaryResponseToJSON(
  json: any,
): WorkflowExecutionSummaryResponse {
  return WorkflowExecutionSummaryResponseToJSONTyped(json, false);
}

export function WorkflowExecutionSummaryResponseToJSONTyped(
  value?: WorkflowExecutionSummaryResponse | null,
