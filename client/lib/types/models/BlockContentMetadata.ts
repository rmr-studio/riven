...
export function BlockContentMetadataFromJSONTyped(
  json: any,
  ...
  return {
    ...
    data: json['data'],
    listConfig:
      json['listConfig'] == null ? undefined : BlockListConfigurationFromJSON(json['listConfig']),
  };
}
...
export function BlockContentMetadataToJSONTyped(
  value?: BlockContentMetadata | null,
