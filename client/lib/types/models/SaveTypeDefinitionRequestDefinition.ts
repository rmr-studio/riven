 ...
 * @export
 */
export type SaveTypeDefinitionRequestDefinition =
  | SaveAttributeDefinitionRequest
  | SaveRelationshipDefinitionRequest;

export function SaveTypeDefinitionRequestDefinitionFromJSON(
  json: any,
): SaveTypeDefinitionRequestDefinition {
  return SaveTypeDefinitionRequestDefinitionFromJSONTyped(json, false);
}

export function SaveTypeDefinitionRequestDefinitionFromJSONTyped(
  json: any,
...
export function SaveTypeDefinitionRequestDefinitionToJSONTyped(
  value?: SaveTypeDefinitionRequestDefinition | null,
