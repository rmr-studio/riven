...
export function ReferenceNodeAllOfReference1FromJSONTyped(
  json: any,
...
export function ReferenceNodeAllOfReference1ToJSONTyped(
  value?: ReferenceNodeAllOfReference1 | null,
