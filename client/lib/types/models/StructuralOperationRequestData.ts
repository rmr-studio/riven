 ...
 * @export
 */
export type StructuralOperationRequestData = AddBlockOperation | MoveBlockOperation | RemoveBlockOperation | ReorderBlockOperation | UpdateBlockOperation;
...
export function StructuralOperationRequestDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): StructuralOperationRequestData {
    if (json == null) {
        return json;
    }
...
export function StructuralOperationRequestDataToJSONTyped(value?: StructuralOperationRequestData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
