 ...
 */
export function instanceOfWorkflowExecutionNodeRecord(
  value: object,
): value is WorkflowExecutionNodeRecord {
...
export function WorkflowExecutionNodeRecordFromJSONTyped(
  json: any,
...
export function WorkflowExecutionNodeRecordToJSONTyped(
  value?: WorkflowExecutionNodeRecord | null,
