 ...
 */
export function instanceOfEntityTypeImpactResponse(value: object): value is EntityTypeImpactResponse {
    return true;
}
...
export function EntityTypeImpactResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTypeImpactResponse {
    if (json == null) {
        return json;
    }
    return {
...
export function EntityTypeImpactResponseToJSONTyped(value?: EntityTypeImpactResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
