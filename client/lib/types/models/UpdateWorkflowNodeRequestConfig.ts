 ...
 * @export
 */
export type UpdateWorkflowNodeRequestConfig = WorkflowActionConfig | WorkflowControlConfig | WorkflowFunctionConfig | WorkflowHumanInteractionConfig | WorkflowTriggerConfig | WorkflowUtilityConfig;

export function UpdateWorkflowNodeRequestConfigFromJSON(json: any): UpdateWorkflowNodeRequestConfig {
    return UpdateWorkflowNodeRequestConfigFromJSONTyped(json, false);
}

export function UpdateWorkflowNodeRequestConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateWorkflowNodeRequestConfig {
    if (json == null) {
        return json;
    }
...
export function UpdateWorkflowNodeRequestConfigToJSON(json: any): any {
    return UpdateWorkflowNodeRequestConfigToJSONTyped(json, false);
}

export function UpdateWorkflowNodeRequestConfigToJSONTyped(value?: UpdateWorkflowNodeRequestConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
