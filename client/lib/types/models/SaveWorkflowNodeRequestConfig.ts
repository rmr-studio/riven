 ...
 * @export
 */
export type SaveWorkflowNodeRequestConfig =
...
export function SaveWorkflowNodeRequestConfigFromJSONTyped(
  json: any,
...
export function SaveWorkflowNodeRequestConfigToJSONTyped(
  value?: SaveWorkflowNodeRequestConfig | null,
